# -*- coding: utf-8 -*-
"""Lehren - was der Review-Durchgang gekostet hat, in Saetzen.
...
LEHREN = [
    ...
    (
        "import-einfuegen",
        "Fehler verhindern",
        "Eine Import-Zeile automatisch einfügen: nur hinter einer ABGESCHLOSSENEN Import-Anweisung",
