# -*- coding: utf-8 -*-
"""Gegenprobe zur Block-Zusammenfassung im Doppelcode-Melder.
...
class DoppelcodeProbe(SimpleTestCase):
    """Fenster zusammenfassen - aber nur die, die zusammengehoeren."""
    ...
    def test_angrenzende_fenster_werden_eins(self):
        """Drei Fenster, je eine Zeile weiter = ein Block von acht Zeilen."""
        roh = [["a.py:10", "b.py:100"], ["a.py:11", "b.py:101"], ["a.py:12", "b.py:102"]]
        ...
        self.assertEqual(orte, ["a.py:10", "b.py:100"], "Gemeldet wird der ANFANG des Blocks.")
        self.assertEqual(
            laenge, 8, "Sechs Zeilen Fenster plus zwei Verschiebungen = acht Zeilen echte Blocklaenge."
        )

    def test_leerzeile_im_block_bricht_nicht(self):
        """Der Melder überspringt Leerzeilen - die Nummern springen."""
        roh = [["a.py:10", "b.py:100"], ["a.py:12", "b.py:102"]]
        self.assertEqual(
            len(self._fassen(roh)),
            1,
    ...
    def test_getrennte_stellen_bleiben_getrennt(self):
        """Ohne diese Richtung wäre das Zusammenfassen wertlos."""
        roh = [["a.py:10", "b.py:100"], ["a.py:400", "b.py:900"]]
        self.assertEqual(
            len(self._fassen(roh)),
            2,
    ...
    def test_andere_partnerdateien_bleiben_getrennt(self):
        """Gleiche Zeilenfolge, andere Dateien = anderer Block."""
        roh = [["a.py:10", "b.py:100"], ["a.py:11", "c.py:101"]]
        self.assertEqual(
            len(self._fassen(roh)),
            2,
