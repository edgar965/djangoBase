# -*- coding: utf-8 -*-
"""JsStilfassungen - welche Inline-Stile lohnen eine CSS-Klasse?
...
class JsStilfassungen(Werkzeug):
    ...
    zweck = (
        'Gruppiert `style="…"` nach Inhalt: Welche Fassung steht wie oft da und lohnt damit eine CSS-Klasse?'
    )
    befund = (
        "3DTools: 1.266 Inline-Stile in nur 485 Fassungen — die haeufigste "
        "78-mal, die zweithaeufigste 61-mal. Nach dem Zusammenfassen "
        "blieben 494 Einzelfaelle."
    )
    abhilfe = (
        "`python -m djangobase.umbau.stilklassen <vorlage.html> "
...
"""
    ...
    def laufen(self):
        ...
        zeilen = [
            {"anzahl": anzahl, "fassung": fassung[:110]}
