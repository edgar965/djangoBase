...
class Vorlagenvariablen(Werkzeug):
    ...
    wann = ('Wenn eine Seite langsam ist und das Profil nur Django-Interna '
            'zeigt. Grosse {% for %}-Schleifen kosten pro Durchlauf eine '
            'Aufloesung je Variable — das summiert sich, ohne dass eine einzelne '
            'Funktion auffaellt.')
    beleg = ('Eine Einstellungsseite kam auf 70.772 Aufloesungen bei nur ACHT '
