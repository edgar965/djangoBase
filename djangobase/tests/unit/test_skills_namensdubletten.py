# -*- coding: utf-8 -*-
"""Namens-Dubletten — und die Namen, die das Rahmenwerk vorschreibt.
...
class NamensdublettenTest(BasisTest):
    ...
    def test_privatname_mit_gleicher_signatur_bleibt_still(self):
        """`_parse` in zwanzig Modulen ist keine Dublette, sondern ein kurzer Name.
    ...
    def test_privatname_mit_anderer_signatur_wird_gemeldet(self):
        """Derselbe Name für zwei verschiedene Rechnungen — der eigentliche Fall."""
    ...
    def test_der_befund_nennt_beide_signaturen(self):
        """Ohne die Parameterlisten muss man beide Dateien aufschlagen."""
    ...
    def test_private_klassen_bleiben_aussen_vor(self):
        """Eine Klasse hat keine Parameterliste, an der man sie unterscheiden könnte."""
        satz = self._lauf(
            {
