# -*- coding: utf-8 -*-
"""Wer ruft wen — für Funktionen dasselbe, was das Klassenmodell für
Klassen leistet.
...
class WerRuftWen(BasisTest):
    ...
    def test_eine_klasse_gilt_als_rufer(self):
        """Nicht die einzelne Methode — im Bild ist die Klasse der Kasten."""
        self.assertEqual(self._kette().steckbrief("zeichne")["genutzt_von"], ["Seite"])

    def test_ueber_dateigrenzen_hinweg(self):
        """DER FEHLER AUS DEM ERSTEN WURF: Bei EINEM Durchgang zaehlte nur,
    ...
    def test_eingebaute_zaehlen_nicht(self):
        """Ohne diese Liste ist `len` der meistgenutzte Baustein."""
    ...
    def test_ein_methodenaufruf_wird_nicht_geraten(self):
        """`self.zeichner.malen()` — der Name `malen` sagt nichts darueber,
