# -*- coding: utf-8 -*-
"""Der Ausnahme-Vermerk von `lehren-treue` — und seine Grenzen.
...
class VermerkTest(SimpleTestCase):
    def test_ohne_vermerk_ist_es_ein_verstoss(self):
        """DIE GEGENPROBE: Ohne Vermerk muss der Waechter anschlagen."""
    ...
    def test_vermerk_fuer_eine_ANDERE_lehre_zaehlt_nicht(self):
        """Sonst waere ein einziger Vermerk ein Freibrief fuer alles."""
    ...
    def test_vermerk_gilt_in_der_ganzen_funktion(self):
        """DER FALL AUS `koerperhuelle.py`: sieben Zeilen Messwerte dazwischen."""
