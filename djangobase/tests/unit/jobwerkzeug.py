# -*- coding: utf-8 -*-
"""Werkzeug fuer die Job-Pruefungen: Attrappen und ein eigener Ordner.
...
class ErkennungAttrappe:
    """Liefert einen festen Bestand und zaehlt, wie oft sie gefragt wurde."""
    ...
    def ermitteln(self):
        self.aufrufe += 1
        return [
            {"kennung": k, "name": k, "app": "test", "art": self.art, "hilfe": ""}
            for k in sorted(self.kennungen)
        ]


class MitTempordner:
    """Gibt jeder Pruefung einen eigenen Ordner und raeumt ihn weg.
    ...
    def datei(self, name):
        """Ein Pfad in diesem Ordner - die Datei muss nicht existieren."""
