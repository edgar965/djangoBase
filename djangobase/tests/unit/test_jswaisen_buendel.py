# -*- coding: utf-8 -*-
"""Ein gebündeltes Frontend ist kein Friedhof.
...
class BuendelBasis(WerkzeugBasis):
    """Ein Miniprojekt mit Vite-Konfiguration, Einstieg und zwei Modulen."""
    ...
    DATEIEN = {
        ...
        "templates/seite.html": '<script type="module" src="/static/app-buendel.js"></script>\n',
...
class EinGebuendeltesFrontend(BuendelBasis):
    """Gegeben: Vite baut aus `src/main.js`."""
...
class EineEchteWaiseDaneben(BuendelBasis):
    """GEGENPROBE: Der Prüfer darf nicht blind geworden sein.
    ...
    def test_sie_wird_gemeldet(self):
        offen = self.waisen(
            self.zeilen({"frontend/src/vergessen.js": "export function niemandRuftMich() { return 2; }\n"})
        )
