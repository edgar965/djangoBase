...
class TailLinesTest(SimpleTestCase):
    ...
    def test_wenige_sehr_lange_zeilen_sprengen_den_speicher_nicht(self):
        ...
        self.assertLessEqual(
            ...
            "es wurden %.1f MB gelesen, Grenze ist %.1f MB" % (gelesen / 1048576, MAX_TAIL_BYTES / 1048576),
        )
    ...
    def test_rotierte_dateien_werden_mitgelesen(self):
        ...
        z = _tail_lines(f, 10)
        self.assertEqual(z, ["alt1", "alt2", "neu1", "neu2"], "Reihenfolge alt->neu stimmt nicht: %r" % z)
