...
from ..skills3 import werkzeug_finden, werkzeuge
from ..skills.lehren_review import BEREICHE, LEHREN, Lehrenstand
from ..skills.werkzeug_alt import Ausgabe, Werkzeug


class Skills3View(ZugriffMixin, View):
    ...
    def _seite(self, request, ausgabetext, gelaufen):
        ...
        return render(request, 'djangobase/hilfe/skills3.html', {
            'aktiv': 'skills3',
