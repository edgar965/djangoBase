...
from .skills2 import Skills2View
from .skills3 import Skills3View
...
__all__ = [
    "api_system_stats","LogsView", "LogsClearView", "VersionsView", "TestsView", "TestDauerView", "TestVerschiebenView", "JobsView",
