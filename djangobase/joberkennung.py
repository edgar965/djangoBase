# -*- coding: utf-8 -*-
"""Die Jobs eines Projekts selbst finden - ohne dass jemand sie eintraegt.
...
class Joberkennung:
    """Findet die Jobs des laufenden Projekts.
    ...
    # ----------------------------------------------------------- ermitteln
    def ermitteln(self):
        """Alle Jobs: erst die Befehle, dann die angemeldeten Daemons."""
    ...
    def befehle(self):
        """Die Management-Commands der Projekt-Apps."""
    ...
    @staticmethod
    def _hilfe(name):
        """Die erste Zeile der Command-Hilfe.
        ...
        try:
            ...
            logger.debug("Joberkennung._hilfe: %r nicht ladbar", name, exc_info=True)
            return ""

    @staticmethod
    def daemons():
        """Die in ``djangobase.jobs`` angemeldeten Hintergrund-Jobs.
