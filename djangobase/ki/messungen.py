...
MESSUNGEN = (
    {
        ...
        "ct_je_frage": 0.0,
        "note": "1-",
        "note_grund": "Fand den echten Mechanismus als ERSTES - aber nur in einem von zwei Läufen; qwen3.8-max fand ihn später beim ersten Versuch.",
    ...
    },
    {
        ...
        "ct_je_frage": 0.18,
        "note": "2",
        "note_grund": "Zuverlässig bei den Standardeinwänden, sechs Sekunden je Frage, Zehntelcent - aber ohne Tiefe.",
    ...
    },
    {
        ...
        "ct_je_frage": 0.0,
        "note": "2-",
        "note_grund": "War der beste lokale Kritiker, solange qwen3.8:27b auf der 12-GB-Karte unbrauchbar war. Auf der RTX PRO 4500 findet qwen3.8 mehr und ist kaum langsamer.",
    ...
    },
    {
        ...
        "ct_je_frage": 0.0,
        "note": "5",
        "note_grund": "Erfindet Quellen mitsamt praeziser Zahlen und verrechnet sich um Faktor 500. Schnell und unbrauchbar.",
    ...
    },
    {
        ...
        "ct_je_frage": 0.93,
        "note": "2",
        "note_grund": "Beste Trefferzahl im Feld und die erste eigenständige Signifikanz-Rechnung - dafür 74 s und knapp ein Cent je Frage.",
    ...
    },
    {
        ...
        "ct_je_frage": 0.4,
        "note": "1-",
        "note_grund": "Die sauberste Antwort auf den Prüfstein im ganzen Feld - fand den versteckten Mechanismus beim ersten Versuch und benannte ihn präziser als nemotron.",
    ...
    },
    {
        ...
        "ct_je_frage": 0.02,
        "note": "2-",
        "note_grund": "Inhaltlich nur Mittelmaß, aber 11 s je Frage für zwei Hundertstel Cent - das beste Verhältnis im ganzen Feld.",
    ...
    },
    {
        ...
        "ct_je_frage": 0.30,
        "note": "1-",
        "note_grund": "Findet 5 der 6 versteckten Kernpunkte - mehr als jedes andere gemessene Modell, lokal wie online.",
    ...
    },
    {
        ...
        "ct_je_frage": 0.22,
        "note": "3-",
        "note_grund": "Schnell und billig, findet aber nur 2 der 6 Kernpunkte - bei der Zellen-Rechnung und den schwachen Jahren gar keinen.",
    ...
    },
    {
        ...
        "ct_je_frage": 0.0,
        "note": "4",
        "note_grund": "Hoechste Trefferzahl aller lokalen Modelle (5/6) - und trotzdem schwach: Die Treffer sind gestreute Stichworte, der Mechanismus fehlt.",
    ...
    },
    {
        ...
        "ct_je_frage": 0.0,
        "note": "3",
        "note_grund": "Dasselbe Modell wie qwen3.8:27b, nur genauer quantisiert. Inhaltlich gleichwertig, aber doppelter Speicher und ein Drittel weniger Tempo - ob Q8 inhaltlich mehr kann, ist mit einem Lauf nicht messbar.",
    ...
    },
    {
        ...
        "ct_je_frage": 0.0,
        "note": "3",
        "note_grund": "Findet den Mechanismus mit durchgerechnetem Szenario - und stellt daneben eine Rechnung mit falschem Vorzeichen auf. 38 s je Frage.",
    ...
    },
    {
        ...
        "ct_je_frage": 0.0,
        "note": "5",
        "note_grund": "70 Mrd. Parameter in Q2 - und das schwaechste Ergebnis im lokalen Feld. Grobe Quantisierung kostet mehr, als die Parameter einbringen.",
    ...
    },
    {
        ...
        "ct_je_frage": 0.0,
        "note": "1-",
        "note_grund": "Findet 5 der 6 Kernpunkte - so viele wie die besten Online-Modelle -, braucht 50 s je Frage und kostet nichts. Das beste lokale Modell, das hier je gemessen wurde.",
    ...
    },
    {
        ...
        "ct_je_frage": 0.60,
        "note": "5",
        "note_grund": "Ein Totalausfall unter drei Fragen disqualifiziert - dazu dreimal teurer und elfmal langsamer als das eigene Nachfolgemodell.",
        ...
        "einschraenkung": "EIN TOTALAUSFALL: 144 Sekunden gerechnet, dann eine leere Antwort zurückgegeben.",
    },
    {
        ...
        "ct_je_frage": 0.05,
        "note": "5",
        "note_grund": "Nennt zuverlässig die Lehrbuch-Einwände und keinen der beiden versteckten Punkte.",
...
#: (E402: steht bewusst am Ende, F401: oeffentlicher Name dieser Datei)
from .befunde import BEFUNDE  # noqa: E402, F401
...
class Bestenliste:
    ...
    def _katalogdaten(self, kennung):
        ...
        for z in self.katalog.online_roh():
            if z["id"] == kennung:
                ...
                # Dictionary gewollt: geht als JSON an hilfe_ki_modelle.html,
                # offscreen_compiled.js, architektur_gpu.html (5 von 5 Schlüsseln stehen dort
                # wörtlich, geprüft mit Skills2 → Anzeigeformat).
                return {
                    "param_gesamt": gefunden["param_gesamt"],
        ...
        for z in self.katalog.lokal():
            if z["kennung"] == kennung:
                ...
                # wörtlich, geprüft mit Skills2 → Anzeigeformat).
                return {
                    "param_gesamt": z["param_gesamt"],
                    "param_aktiv": z["param_aktiv"],
                    "kontext": z.get("kontext"),
                    "gb": z["gb"],
    ...
    def zeilen(self, nur_empfohlen=False):
        ...
        for m in MESSUNGEN:
            ...
            zeile["letzter_lauf"] = max(zeile["sparring_stand"], zeile["tempo_stand"]) or ""
    ...
    @staticmethod
    def _de_datum(iso):
        """``2026-09-01`` -> ``01.09.2026``. Leer bleibt leer.
